...
public class ChooseAreaActivity extends Activity {
    ...
    private JackWeatherDB jackWeatherDB;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        jackWeatherDB = JackWeatherDB.getInstance(this);
    ...
    private void queryProvinces() {
        provinceList = jackWeatherDB.loadProvinces();
    ...
    private  void queryCities() {
        cityList = jackWeatherDB.loadCities(selectedProvince.getId());
        if (cityList.size() > 0) {
            dataList.clear();
    ...
    private void queryCounies() {
        countyList = jackWeatherDB.loadCounties(selectedCity.getId());
        ...
        HttpUtil.sendHttpRequest(address, new HttpCallbackListener() {
            ...
            public void onFinish(String response) {
                ...
                if ("province".equals(type)) {
                    result = Utility.handleProvincesResponse(jackWeatherDB, response);
                } else if ("city".equals(type)) {
                    result = Utility.handleCitiesResponse(jackWeatherDB,response,selectedProvince.getId());
                } else if ("county".equals(type)) {
                    result = Utility.handleCountiesResponse(jackWeatherDB,response,selectedCity.getId());
                }
                if (result) {
